...
if (Config.LANG == 'EN') ldc = '*Link Detected! Sharing a link is not allowed here i am removing you.  , oke bye \n\n 🕊🕊*'
...
if (Config.LANG == 'UR') ldc = '*معذرت کے ساتھ یہاں لنک بھیجنا منع ہے اس لیے آپ کو  گروپ سے نکالا جاتا  ہے*'
