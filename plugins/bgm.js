...
if (config.LANG == 'UR') {
        l_dsc = 'بیگرونڈ میوزک کو چالو یا بند کرنے کے لئے - بوٹ کے مالک کے لئے کمانڈ'
        alr_on = '!اینٹی لنک پہلے سے ہی نہیں چل رہا ہے'
        alr_off = '!اینٹی ٹینک فلحال بند ہے'
        BGM_on = 'بیگرونڈ میوزک بحال کر دیا گیا ہے'
        BGM_off = 'بیگرونڈ میوزک بند کر دیا گیا ہے'
    }
