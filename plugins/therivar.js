...
let baseURI = '/apps/' + config.HEROKU.APP_NAME;
   ...
   var l_dsc = ''
    ...
    if (config.LANG == 'EN') {
        l_dsc = 'activates antilink tool. -bot owner command'
...
if (config.LANG == 'UR') {
        l_dsc = 'اینٹی لنک ٹول کو چالو کرتا ہے ہے- بوٹ مالک کی کمانڈ'
        alr_on = 'اینٹی لنک ٹول پہلے سے ہی چل رہا ہے'
        alr_off = 'اینٹی لنک ٹول فلحال بند ہے'
        THERI_on = '*بیگرونڈ میوزک چلا دیا گیا ہے*'
        THERI_off = '*بیگرونڈ میوزک بند کر دیا گیا*'
    }
